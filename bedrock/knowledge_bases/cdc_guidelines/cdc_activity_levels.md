...
_Source: CDC Respiratory Virus Activity Levels Dashboard FAQ (https://www.cdc.gov/respiratory-viruses/data/faqs.html), CDC Respiratory Illnesses Data Channel_
...
- **CDC Socrata API**: `https://data.cdc.gov/resource/vutn-jzwm.json`
  - Dataset: "NSSP Emergency Department Visits - COVID-19, Flu, RSV, Combined"
  - Fields: geography, pathogen, week_end, percent_visits
